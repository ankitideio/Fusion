...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func sceneWillResignActive(_ scene: UIScene) {
        saveDotStatus(dot: 0)
        NotificationCenter.default.post(name: NSNotification.Name("NotificationDotRemove"), object: nil, userInfo: nil)
...
extension SceneDelegate{
    ...
    func setHomeeRoot(){
            ...
            let redViewController = mainStoryBoard.instantiateViewController(withIdentifier: "NotesLIstVC") as! NotesLIstVC
